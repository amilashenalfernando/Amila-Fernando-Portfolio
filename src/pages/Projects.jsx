...
const projects = [
    ...
    },
    {
        ...
        title: "Portfolio v1",
        category: "Web App",
        image: "https://placehold.co/600x400/1e293b/f97316?text=Portfolio+v1",
        description: "My previous personal website showcasing early layout experiments and animations.",
    ...
    },
    {
        ...
        category: "Mobile App",
        image: "https://placehold.co/600x400/1e293b/f97316?text=Task+Manager",
        description: "A productivity app for tracking daily tasks with push notifications and cloud sync.",
...
const Projects = () => {
    ...
    const handleDemoClick = (e, project) => {
        ...
        if (project.demo && (project.demo.endsWith('.mp4') || project.demo.endsWith('.webm'))) {
            e.preventDefault();
            setSelectedVideo({
                url: project.demo,
                title: project.title
                ...
                <AnimatePresence mode="popLayout">
                    {filteredProjects.map((project) => (
                        <motion.div
                            ...
                            className="glass-card flex flex-col h-full hover-lift group overflow-hidden w-full md:w-[calc(50%-2rem)] lg:w-[calc(33.33%-2rem)] max-w-sm cursor-pointer relative"
                        >
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                <div className="flex justify-between items-start mb-4">
                                    ...
                                    <div className="flex gap-3 text-gray-400">
                                        ...
                                        <a href={project.demo} target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors"><FiExternalLink size={20} /></a>
                                    </div>
                                </div>
                ...
                {selectedProject && (
                    <div className="fixed inset-0 z-[60] flex items-center justify-center px-4 pointer-events-none">
                        ...
                        <motion.div
                            ...
                            className="w-full max-w-lg relative z-10 pointer-events-auto font-sans"
                        >
                            {/* Orange Glow Underlay */}
                            <div className="absolute -inset-1 bg-orange-600/30 rounded-lg blur-md" />

                            <div className="relative bg-[#050505] rounded-lg overflow-hidden border border-orange-500/30 flex flex-col shadow-2xl">
                                {/* Decorative Tech Header */}
                                <div className="h-1.5 w-full bg-gradient-to-r from-orange-600 to-red-600" />
                                ...
                                <button
                                    onClick={() => setSelectedProject(null)}
                                    className="absolute top-4 right-4 z-20 p-1.5 bg-black/80 text-gray-400 hover:text-orange-500 transition-colors border border-white/10 hover:border-orange-500/50 rounded-md"
                                >
                                    <FiX size={20} />
                                </button>

                                {/* Image Section */}
                                <div className="relative h-56 bg-[#0a0a0a] flex items-center justify-center p-0 border-b border-white/5">
                                    {/* Grid Background */}
                                    <div className="absolute inset-0 opacity-10"
                                        style={{ backgroundImage: 'linear-gradient(#333 1px, transparent 1px), linear-gradient(90deg, #333 1px, transparent 1px)', backgroundSize: '16px 16px' }}
                                    />
                                ...
                                <div className="p-8 relative -mt-12 z-20">
                                    <div className="flex justify-between items-start mb-5">
                                        <div>
                                            <div className="flex items-center gap-2 mb-2">
                                                <span className="text-[10px] font-mono uppercase tracking-widest text-orange-500 bg-orange-500/10 px-2 py-0.5 rounded border border-orange-500/20">
                                                    Featured Project
                                                </span>
                                                <span className="text-[10px] font-mono text-gray-500">ID: {selectedProject.id.toString().padStart(4, '0')}</span>
                                            </div>
                                            <h2 className="text-3xl font-bold text-white leading-tight mb-2">{selectedProject.title}</h2>
                                    ...
                                    <p className="text-gray-300 leading-relaxed mb-6 border-l-2 border-orange-500/50 pl-4">
                                    ...
                                    <div className="flex items-center gap-2 mb-5 opacity-20">
                                        ...
                                        <div className="text-[10px] text-white font-mono">TECH_STACK</div>
                                        <div className="h-px bg-white flex-grow" />
                                    </div>

                                    <div className="flex flex-wrap gap-2 mb-8">
                                        {selectedProject.stack.map((tech, idx) => (
                                            <span key={idx} className="text-xs font-mono text-gray-300 bg-[#111] border border-white/10 px-2 py-1 rounded">
                                                _{tech}
                                            </span>
                                        ))}
                                    </div>
                                    ...
                                    <div className="flex gap-3">
                                        {selectedProject.demo && selectedProject.demo !== "#" && (
                                            <motion.a
                                                ...
                                                whileTap={{ scale: 0.98 }}
                                                className="flex-1 py-3 bg-orange-600 hover:bg-orange-500 text-white font-bold font-mono tracking-wide rounded text-center flex items-center justify-center gap-2 overflow-hidden relative group"
                                            >
                                                <span className="relative z-10">LIVE_DEMO</span>
                                        ...
                                        {selectedProject.github && selectedProject.github !== "#" && (
                                            <motion.a
                                                ...
                                                whileHover={{ scale: 1.02 }}
                                                whileTap={{ scale: 0.98 }}
                                                className="flex-1 py-3 bg-[#111] hover:bg-[#222] text-white font-bold font-mono tracking-wide rounded text-center flex items-center justify-center gap-2 border border-white/10"
                                            >
