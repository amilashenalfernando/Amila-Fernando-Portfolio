            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                >
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <a href="mailto:amilafernando2004@gmail.com" className="text-gray-300 hover:text-orange-400 transition-colors">
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <a href="tel:+94711237591" className="text-gray-300 hover:text-orange-400 transition-colors">
                                    +94 71 123 7591
                                </a>
                            </div>
                        </div>
                    ...
                    <div className="w-full h-64 md:h-80 rounded-2xl overflow-hidden shadow-lg border border-white/10 mt-4 relative group">
                        ...
                        <iframe
                            src="https://maps.google.com/maps?q=Katuneriya,%20Sri%20Lanka&hl=en&z=14&output=embed"
                            width="100%"
                            height="100%"
                            style={{ border: 0 }}
                            allowFullScreen=""
                            ...
                            className="bg-[#242f3e] grayscale group-hover:grayscale-0 transition-all duration-700"
                            title="SLTC Location"
                        ></iframe>
                ...
                <motion.div
                    ...
                    className="glass-card p-8 md:p-10 border border-white/5 bg-[#0a0a0a]/50"
                >
                    <form onSubmit={onSubmit} className="space-y-6">
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                type="text"
                                required
                                className="w-full bg-[#151515] border border-white/10 rounded-xl p-4 text-white focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition-colors"
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea
                                ...
                                rows="5"
                                required
                                className="w-full bg-[#151515] border border-white/10 rounded-xl p-4 text-white focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition-colors resize-none"
