...
const Home = () => {
    return (
        <div className="flex flex-col items-center justify-center min-h-[85vh] text-center w-full pt-10">
            ...
            <motion.div
                ...
                className="glass-card p-10 md:p-14 max-w-5xl w-full mx-4 flex flex-col items-center relative overflow-hidden"
            >
